...
export default function StatusPage({ feeds, logs, reloadFeeds, reloadLogs }) {
  ...
  return (
    <>
      ...
      <section className="panel">
        <div className="panel-header"><h2>抓取记录</h2><button onClick={reloadLogs}><RefreshCw size={16} />刷新记录</button></div>
